...
export class UserPasswordNullable1768593126199 implements MigrationInterface {
    name = 'UserPasswordNullable1768593126199'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "team" ADD CONSTRAINT "UQ_cf461f5b40cf1a2b8876011e1e1" UNIQUE ("name")`);
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "password_hash" nvarchar(255)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "password_hash" nvarchar(255) NOT NULL`);
